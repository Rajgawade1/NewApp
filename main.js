...
const baseUrl = "https://52.74.27.20:444/";
...
let LoginmodalComponent = class LoginmodalComponent {
    ...
    setError(data) {
        this.openSnackBar("Something went wrong", "" + data.detail);
        console.log("Error Occured" + data.detail);
...
/* harmony import */ var _data_get_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../data-get.service */ "./src/app/data-get.service.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _common_service_urls__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/service-urls */ "./src/app/common/service-urls.ts");
...
let OutputComponent = class OutputComponent {
    constructor(fb, dataSubmitService, dataGetService, globals, _snackBar) {
        ...
        this.globals = globals;
        this._snackBar = _snackBar;
        this.baseUrl = _common_service_urls__WEBPACK_IMPORTED_MODULE_7__["baseUrl"];
    }
    ngOnInit() {
    ...
    downloadResume() {
        ...
        window.location.assign(this.baseUrl + "/generate_resume/?userId=9");
...
let RegisterService = class RegisterService {
    constructor(http) {
        this.http = http;
        //baseUrl="http://100.83.14.249:8000";
        this.baseUrl = _common_service_urls__WEBPACK_IMPORTED_MODULE_5__["baseUrl"];
        this.httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        this.data = [{ "title": "Lion king" }];
    }
...
let RegisterComponent = class RegisterComponent {
    constructor(registerService) {
        ...
        this.registerForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            "username": new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('123', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(3)]),
